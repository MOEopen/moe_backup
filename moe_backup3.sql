...
--
-- Host: 127.0.0.1:3307
-- Erstellungszeit: 26. Aug 2014 um 12:03
...
--
DROP TABLE IF EXISTS `moe_backup`;
CREATE TABLE IF NOT EXISTS `moe_backup` (
  ...
  `MOECOMPRESSIONSCHEME` varchar(100) NOT NULL,
...
INSERT INTO `moe_backup` (`OXID`, `OCBTITLE`, `OCBTITLE_1`, `MOEFILEPREFIX`, `OCBDATETIME`, `MOEBACKUPDIR`, `MOELOGGINGDIR`, `MOEINCLUDE`, `MOEEXCLUDE`, `MOECOMPRESSIONSCHEME`, `MOEDESCRIPTION`) VALUES
